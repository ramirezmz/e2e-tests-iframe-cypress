...
describe('Quizzes', () => {
  ...
  it('The user should be able to create a quiz.', () => {
    ...
    // Título da enquete
    comunicados.inputTitleQuiz()

    // Descrição da enquete
    comunicados.inputDescriptionQuiz()
    ...
    comunicados.inputTitleTextQuestion()
    ...
    comunicados.inputDescriptionChoiceQuestion(CREATE_QUIZ.description_choice_question)

    comunicados.setThreeOptionsMultipleChoiseQuestion(CREATE_QUIZ.three_options_multiple_choise_question)
    ...
    comunicados.inputTitleChoiceQuestion(CREATE_QUIZ.title_unique_choice_question)
    comunicados.inputDescriptionChoiceQuestion(CREATE_QUIZ.description_unique_choice_question)

    //  Prencher Enquete de Seleção Única
    comunicados.setThreeOptionsCheckBoxQuestion(CREATE_QUIZ.three_option_checkbox_question)
    ...
    comunicados.inputTitleChoiceQuestion(CREATE_QUIZ.title_linear_scale_question)
    comunicados.inputDescriptionChoiceQuestion(CREATE_QUIZ.description_linear_scale_question)
    comunicados.inputMinMaxScaleQuestion(CREATE_QUIZ.min_scale_question, CREATE_QUIZ.max_scale_question)
    ...
    comunicados.inputDescriptionChoiceQuestion(CREATE_QUIZ.description_load_file)
    comunicados.unableObrigatoryQuestion()
